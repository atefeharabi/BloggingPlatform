...
const Menu = withRouter(({history}) => (
  <AppBar position="static">
    <Toolbar style={{ backgroundColor: 'rgb(41, 41, 41)' }}>
    <img src={teamLogo} style={{ width: '100px', height: '100px' }} alt="Team Logo" />
      ...
      {
        auth.isAuthenticated() && (<span>
          {auth.isAuthenticated().user.seller && (<Link to="/seller/shops"><Button style={isPartActive(history, "/seller/")}>My Blogs</Button></Link>)}
